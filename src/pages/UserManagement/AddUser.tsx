...
export const AddUser = () => {
  ...
  return (
    <>
      <DefaultLayout>
        <div className="w-full flex flex-col justify-center items-center md:w-[50rem] h-fit mx-auto px-[1rem] md:px-[2.5rem] text-black py-12 pt-6 bg-white border-0">
          ...
          <form id="form" noValidate onSubmit={handleAddUser} ref={AddUserForm}>
            <div className="">
              ...
              <div className="relative mt-[2rem] mb-[1.65rem] -top-2 z-0 w-[23rem]">
                <select
                  name="role"
                  value={rolevalue}
                ...
                >
                  <option className="w-[22rem] p-[1.5rem] border-basecolor border-2">
                    Admin
                  </option>
                  <option className="w-[22rem]">User</option>
                </select>
                <label
                  htmlFor="role"
                  className="relative duration-300 -top-[4.35rem] -z-1 origin-0 text-gray-500"
