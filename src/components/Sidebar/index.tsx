...
const Sidebar = ({ sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-9999 flex h-screen w-full md:w-[20.5rem] flex-col overflow-y-hidden bg-basecolor duration-300 ease-linear dark:bg-boxdark lg:static lg:translate-x-0 ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        <NavLink to="/">
          <div className="flex justify-center relative left-[5rem]">
            ...
            <ul className="mb-6 flex flex-col gap-1.5 ">
              ...
              <div>
                <li className="mb-[0.85rem]">
                  <NavLink
                    to="/"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-black dark:hover:bg-meta-4 ${
                      (pathname.endsWith('/') ||
                ...
                <li className="mb-[0.85rem]">
                  <NavLink
                    to="/ItemManagement"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-black dark:hover:bg-meta-4 ${
                      pathname.includes('ItemManagement') &&
                      'bg-black dark:bg-meta-4'
                    }`}
                  >
                    <div className="text-2xl">
                ...
                <li className="mb-[0.85rem]">
                  <NavLink
                    to="/BranchManagement"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-black dark:hover:bg-meta-4 ${
                      pathname.includes('BranchManagement') &&
                      'bg-black dark:bg-meta-4'
                    }`}
                  >
                ...
                <li className="mb-[0.85rem]">
                  <NavLink
                    to="/TerminalManagement"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-white duration-300 ease-in-out hover:bg-black dark:hover:bg-meta-4 ${
                      pathname.includes('TerminalManagement') &&
                      'bg-black dark:bg-meta-4'
                    }`}
                  >
                    <div className="text-2xl">
